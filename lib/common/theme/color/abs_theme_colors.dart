import 'package:gamel_flutter_ttoss/common/constant/app_colors.dart';
import 'package:flutter/material.dart';

export 'package:gamel_flutter_ttoss/common/constant/app_colors.dart';
...
abstract class AbstractThemeColors {
  ...
  Color get roundedLayoutBackground => const Color.fromARGB(69, 24, 24, 24 );

  Color get unreadColor => const Color.fromARGB(255, 48, 48, 48 );

  Color? get leesImportant => AppColors.grey;
